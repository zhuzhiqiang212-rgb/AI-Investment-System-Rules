...
_ARCH_REDUCE = {
    "US.AVGO": {"四条件": "①否(AI订单$73B/6大客户/谷歌苹果至2031/Q3 AI+200%/FY27目标$100B+) ②否 ③是(仓位超限) ④否(仅高于合理上沿约2%·上沿$362·未达30%止盈线)",
                "六行": ("<b>减博通不是因为它变差，是AI供应链65.9%超45%上限（只③仓位超限成立）。</b>",
                         "③仓位超限——AI供应链占比超正式配置上限",
                         "AI供应链65.9%·上限45%；超合理上沿约+2%（上沿$362·现价见卡顶动作表·未达30%止盈线）",
                         "—（非④触发·不计数）",
                         "降AI集中时优先减最贵的（见现金减仓表）→系统提请拍板，不自动减",
                         "AI供应链回到45%以内即取消")},
    "US.META": {"四条件": "①否(Q1营收$56.31B+33%/AI把广告转化率提升超6%·首次量化) ②观察(资本开支上调$125-145B·Q1财报后跌6-7%) ③是 ④否",
                "六行": ("<b>减Meta主要由③仓位超限触发·不是变差；②列观察项。</b>",
                         "③仓位超限为主；②利润趋势转弱=观察项（资本开支跑赢收入的迹象）",
                         "AI供应链65.9%超45%；②观察:CY2026资本开支上调至$125-145B·市场担心花钱跑赢赚钱",
                         "—（非④触发·不计数）",
                         "降集中时减；若②连续两季利润趋势转弱则升级为②触发→系统提请拍板",
                         "集中度回落且②未恶化即取消")},
